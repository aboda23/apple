...
export default function MacbookModel16(props) {
  ...
  const { nodes, materials, scene} = useGLTF('/mac/models/macbook-16-transformed.glb')

    const texture = useTexture('/mac/screen.png');
...
useGLTF.preload('/mac/models/macbook-16-transformed.glb')
